package gwienngroupid.gwiennartifact;
...
@Mod(
        modid = GwiennArtifact.MOD_ID,
        name = GwiennArtifact.MOD_NAME,
        version = GwiennArtifact.VERSION
)
public class GwiennArtifact {
     ...
     */
    @Mod.Instance(MOD_ID)
    public static GwiennArtifact INSTANCE;
